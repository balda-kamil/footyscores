...
export function MatchRow({ match, idx, baseUrl = '', endpointsVisible, selected, onSelect, onInspect }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className={`${cell} flex-col items-start justify-center col-stage`}>
      ...
      <div className={`${cell} flex-col items-start justify-center gap-px`}>
        <div className="font-medium text-[13px]">{match.home}</div>
        <div className="text-[10px] text-muted pl-[22px] my-px">vs</div>
        <div className="font-medium text-[13px]">{match.away}</div>
      </div>

      <div className={`${cell} flex-col items-start justify-center col-venue`}>
      ...
      <div className={`${cell} gap-1 col-actions`}>
        <button
          ...
          onClick={(e) => { e.stopPropagation(); onInspect(match); }}
          title="Inspect"
        >
          🔍
        </button>
